...
template<> DISCORDMESSENGER_API UScriptStruct* StaticStruct<FDiscordMessageEmbeds>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/DiscordMessageContent.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FDiscordMessageEmbeds>();
	}
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Color_MetaData[] = {
		{ "Category", "DiscordMessenger" },
		{ "HideAlphaChannel", "" },
		{ "ModuleRelativePath", "Public/DiscordMessageContent.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDiscordMessageEmbeds, Color), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Color_MetaData), Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Color_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Title_MetaData[] = {
		{ "Category", "DiscordMessenger" },
		{ "ModuleRelativePath", "Public/DiscordMessageContent.h" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Title = { "Title", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDiscordMessageEmbeds, Title), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Title_MetaData), Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Title_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Description_MetaData[] = {
		{ "Category", "DiscordMessenger" },
		{ "ModuleRelativePath", "Public/DiscordMessageContent.h" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Description = { "Description", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDiscordMessageEmbeds, Description), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Description_MetaData), Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewProp_Description_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::ReturnStructParams = {
	...
	UScriptStruct* Z_Construct_UScriptStruct_FDiscordMessageEmbeds()
	{
		...
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_DiscordMessageEmbeds.InnerSingleton, Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::ReturnStructParams);
		}
...
template<> DISCORDMESSENGER_API UScriptStruct* StaticStruct<FDiscordMessageContent>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/DiscordMessageContent.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FDiscordMessageContent>();
	}
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::NewProp_Username_MetaData[] = {
		{ "Category", "DiscordMessenger" },
		{ "ModuleRelativePath", "Public/DiscordMessageContent.h" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::NewProp_Username = { "Username", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDiscordMessageContent, Username), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::NewProp_Username_MetaData), Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::NewProp_Username_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::NewProp_Content_MetaData[] = {
		{ "Category", "DiscordMessenger" },
		{ "ModuleRelativePath", "Public/DiscordMessageContent.h" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::NewProp_Content = { "Content", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDiscordMessageContent, Content), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::NewProp_Content_MetaData), Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::NewProp_Content_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_DiscordMessenger,
		nullptr,
		&NewStructOps,
	...
	UScriptStruct* Z_Construct_UScriptStruct_FDiscordMessageContent()
	{
		...
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_DiscordMessageContent.InnerSingleton, Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::ReturnStructParams);
		}
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_DiscordMessenger_Source_DiscordMessenger_Public_DiscordMessageContent_h_Statics::ScriptStructInfo[] = {
		{ FDiscordMessageEmbeds::StaticStruct, Z_Construct_UScriptStruct_FDiscordMessageEmbeds_Statics::NewStructOps, TEXT("DiscordMessageEmbeds"), &Z_Registration_Info_UScriptStruct_DiscordMessageEmbeds, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDiscordMessageEmbeds), 3115353865U) },
		{ FDiscordMessageContent::StaticStruct, Z_Construct_UScriptStruct_FDiscordMessageContent_Statics::NewStructOps, TEXT("DiscordMessageContent"), &Z_Registration_Info_UScriptStruct_DiscordMessageContent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDiscordMessageContent), 96257383U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_DiscordMessenger_Source_DiscordMessenger_Public_DiscordMessageContent_h_2229590904(TEXT("/Script/DiscordMessenger"),
		nullptr, 0,
